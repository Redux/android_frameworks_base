...
public class NotificationManagerService extends INotificationManager.Stub
{
            ...
            String tag, int id, Notification notification, int[] idOut)
    {
        ...
        synchronized (mNotificationList) {
            ...
            try {
                final ProfileManager pm = (ProfileManager) mContext.getSystemService(Context.PROFILE_SERVICE);

                Profile currentProfile = pm.getActiveProfile();
                ProfileGroup pg = pm.getActiveProfileGroup(pkg);
                notification = currentProfile.processNotification(pg.getName(), notification);
            } catch (Throwable th) {
